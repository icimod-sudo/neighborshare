<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Add these inside the navigation links -->
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
        ...
        <x-nav-link :href="route('exchanges.my')" :active="request()->routeIs('exchanges.my')">
            {{ __('My Exchanges') }}
        </x-nav-link>
    </div>
    ...
    <div class="pt-2 pb-3 space-y-1">
        ...
        <x-responsive-nav-link :href="route('exchanges.my')" :active="request()->routeIs('exchanges.my')">
            {{ __('My Exchanges') }}
        </x-responsive-nav-link>
    </div>
</nav>